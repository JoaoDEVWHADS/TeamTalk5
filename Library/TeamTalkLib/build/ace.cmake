...
if (MSVC)
  list (APPEND ACE_COMPILE_FLAGS -DACE_AS_STATIC_LIBS)
  ...
  set (ACE_LINK_FLAGS ${ACESSL_STATIC_LIB} ${ACE_STATIC_LIB})
  ...
  if (ACE_STATIC)
    if (EXISTS "${TTLIBS_ROOT}/ACE/lib/libACE.a")
      ...
      find_library(ACE_STATIC_LIB NAMES libACE.a ACE)
      find_library(ACESSL_STATIC_LIB NAMES libACE_SSL.a ACE_SSL)
      find_library(ACEINET_STATIC_LIB NAMES libACE_INet.a ACE_INet)
      find_library(ACEINETSSL_STATIC_LIB NAMES libACE_INet_SSL.a ACE_INet_SSL)
