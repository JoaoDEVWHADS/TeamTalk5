...
if (MSVC)
  ...
  if (PORTAUDIO_STATIC)
    if (EXISTS "${TTLIBS_ROOT}/portaudio/lib/libportaudio.a")
      set (PORTAUDIO_INCLUDE_DIR ${TTLIBS_ROOT}/portaudio/include)
      set (PORTAUDIO_LINK_FLAGS ${TTLIBS_ROOT}/portaudio/lib/libportaudio.a)
    else()
      find_library(PORTAUDIO_STATIC_LIB NAMES libportaudio.a portaudio)
      set (PORTAUDIO_INCLUDE_DIR /usr/include)
      set (PORTAUDIO_LINK_FLAGS ${PORTAUDIO_STATIC_LIB})
    endif()
  else()
